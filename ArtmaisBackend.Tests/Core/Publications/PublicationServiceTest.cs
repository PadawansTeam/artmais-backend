...
namespace ArtmaisBackend.Tests.Core.Publications
{
    public class PublicationServiceTest
    {
        ...
        public void InsertCommentShouldBeReturnsTrue()
        {
            ...
            var publicationService = new PublicationService(mockSignatureService.Object, mockUserService.Object, mockUserRepository.Object, mockMediaTypeRepository.Object, mockPublicationRepository.Object, mockCommentRepository.Object, mockLikeRepository.Object, mockOptions.Object, mockAnswerRepository.Object);
        ...
        public async Task GetPublicationByIdAndLoggedUserShouldBeReturnsPublicationInfo()
        {
            ...
            var expectedResult = new PublicationDto
            {
                ...
                LikesAmount = 0,
                Name = "Name",
                PublicationFacebook = "https://www.facebook.com/sharer/sharer.php?u=https://artmais-frontend.herokuapp.com/artista/1/publicacao/123%20Olha%20só%20que%20publicação%20incrível%20que%20eu%20achei%20na%20plataforma%20Art%2B.",
                PublicationTwitter = "https://twitter.com/intent/tweet?text=https://artmais-frontend.herokuapp.com/artista/1/publicacao/123%20Olha%20só%20que%20publicação%20incrível%20que%20eu%20achei%20na%20plataforma%20Art%2B.",
                PublicationWhatsapp = "https://wa.me/?text=https://artmais-frontend.herokuapp.com/artista/1/publicacao/123%20Olha%20só%20que%20publicação%20incrível%20que%20eu%20achei%20na%20plataforma%20Art%2B.",
                S3UrlMedia = "S3UrlMedia",
                Subcategory = "SubCategoy",
